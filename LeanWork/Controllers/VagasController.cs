...
namespace LeanWork.Controllers
{
    public class VagasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Tecnologias")] Vaga vaga)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Tecnologias")] Vaga vaga)
        {
            if (id != vaga.Id)
            {
                return NotFound();
